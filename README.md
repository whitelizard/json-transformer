...
Inside the `builtInTransforms` is the `%exec%` transform.
...
Now let's make something more interesting -- let's import [JsonLogic](http://jsonlogic.com), and make more use of context.
